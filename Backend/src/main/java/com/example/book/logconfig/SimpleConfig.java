	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	    http
	        ...
	        .authorizeHttpRequests()
	            .requestMatchers("/api/po", "/api/register","/api/login","/books/add").permitAll()
	            .requestMatchers("/api/get").hasRole("ADMIN")
	            .requestMatchers(HttpMethod.POST, "/api/register", "/api/po","/api/login","api/books/all","/books/add").permitAll()
